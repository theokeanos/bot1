...
.setColor('GREEN')
.setDescription('Başvurunuz Gönderildi En Kısa Sürede <#802126801320017942> Kanalından Cevap Vereceğiz!')
...
client.channels.cache.get('802126801320017942').send(embed2); 
};
exports.conf = {
    enabled: true,
    guildOnly: true,
